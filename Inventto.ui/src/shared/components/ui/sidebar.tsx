...
const SIDEBAR_HEIGHT = 'calc(100vh)';
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          'sticky inset-y-0 z-10 hidden h-(--sidebar-height) w-(--sidebar-width) transition-[left,right,width] duration-200 ease-linear md:flex',
          side === 'left'
