...
} from '@/features/organizations/presentation/hooks/use-mutations';
import { useCandidatesQuery } from '@/features/organizations/presentation/hooks/use-queries';

import type { IMember } from '../../../../../domain/entities';
import { EMAIL_OTHER_TENANT_ERROR } from '../../../../../domain/services';
