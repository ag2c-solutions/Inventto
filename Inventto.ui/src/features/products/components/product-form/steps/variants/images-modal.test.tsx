...
import type {
  IProductImage,
  IProductVariant
} from '@/features/products/types/models';
...
const mockAllImages: IProductImage[] = [
  { id: 'img1', name: 'Img 1', url: 'blob:1', isPrimary: true, type: 'image' },
  { id: 'img2', name: 'Img 2', url: 'blob:2', isPrimary: false, type: 'image' },
  { id: 'img3', name: 'Img 3', url: 'blob:3', isPrimary: false, type: 'image' }
];
