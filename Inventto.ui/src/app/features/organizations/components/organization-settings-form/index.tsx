import { Loader2, Save, Store, Settings2, CalendarClock, AlertCircle } from "lucide-react";
...
export function OrganizationSettingsForm() {
    const { form, onSubmit, isLoading, isDirty, activeTab, setActiveTab } = useOrganizationSettingsForm();
                ...
                <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                    <div className="w-full flex items-center justify-between">
                        <TabsList className="inline-flex w-fit h-fit items-center border bg-transparent justify-center rounded-2xl px-4 gap-4 py-2 text-muted-foreground">
                            ...
                            <TabsTrigger value="operational" className="inline-flex items-center justify-center whitespace-nowrap rounded-md px-3 py-1.5 text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:bg-primary/50 data-[state=active]:text-foreground data-[state=active]:shadow-sm gap-2">
                                <Settings2 className="h-4 w-4" />
                                <span className="hidden sm:inline">Operacional</span>
                            </TabsTrigger>
                            <TabsTrigger value="schedule" className="inline-flex items-center justify-center whitespace-nowrap rounded-md px-3 py-1.5 text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:bg-primary/50 data-[state=active]:text-foreground data-[state=active]:shadow-sm gap-2">
                                <CalendarClock className="h-4 w-4" />
                                <span className="hidden sm:inline">Horários</span>
                            </TabsTrigger>
                        </TabsList>
                        <div className=" items-center  gap-4 px-2 py-2 flex justify-end w-fit">
                            <Button type="button" variant="ghost" onClick={() => form.reset()} disabled={isLoading || !isDirty}>
                                Descartar
                            </Button>
                    ...
                    <TabsContent value="general" className="space-y-6 w-full bg-background/20 p-2 rounded-2xl">
                                    ...
                                    render={({ field }) => (
                                        <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4 shadow-sm bg-muted/20">
                                            <div className="space-y-0.5">
                                                ...
                                                <FormDescription>
                                                    Clientes podem reservar peças de madrugada. A reserva expira ao abrir da loja.
                                                </FormDescription>
                                            </div>
                                            <FormControl>
                                                <Switch
                    ...
                    <TabsContent value="operational" className="space-y-6 w-full bg-background/20 p-2 rounded-2xl">
                        <Card className="w-full bg-transparent border-none shadow-none">
                            <CardHeader>
                            ...
                            <CardContent className="space-y-6">
                                <Alert variant="default" className="bg-blue-50 border-blue-200 text-blue-800">
                                    ...
                                    <AlertDescription>
                                        O sistema usa este campo para calcular automaticamente quando as reservas de estoque expiram.
                                    </AlertDescription>
                                </Alert>
                    ...
                    <TabsContent value="schedule" className="space-y-6 w-full bg-background/20 p-2  rounded-2xl">
                        <Card className="w-full bg-transparent border-none shadow-none">
                            <CardHeader>
                            ...
                            <CardContent>
                                ...
                                {form.formState.errors.schedule && (
                                    <Alert variant="destructive" className="mb-6">
                                        ...
                                        <AlertDescription>
                                            Verifique se todos os dias marcados como "Aberto" possuem horários de início e fim válidos.
                                        </AlertDescription>
                                    </Alert>
                                )}
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <div className="col-span-4 md:col-span-3 font-medium flex items-center gap-2">
                                                    {day.label}
                                                    {dayError && <span className="h-2 w-2 rounded-full bg-red-500" />}
                                                </div>
                                                        ...
                                                        render={({ field }) => (
                                                            <FormItem className="space-y-0 max-w-28">
                                                                <FormControl>
                                                                    <Input
                                                                        type="time"
                                                                        className={cn("h-8", dayError?.open && "border-red-500")}
                                                                        disabled={!isOpen}
                                                                        {...field}
                                                                        value={field.value || ""}
                                                                    />
                                                        ...
                                                        render={({ field }) => (
                                                            <FormItem className="space-y-0 max-w-28">
                                                                <FormControl>
                                                                    <Input
                                                                        type="time"
                                                                        className={cn("h-8", dayError?.close && "border-red-500")}
                                                                        disabled={!isOpen}
                                                                        {...field}
                                                                        value={field.value || ""}
                                                                    />
