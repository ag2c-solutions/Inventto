import { useCreateOrganizationMutation } from "../../hooks/use-query";
...
import { generateSlug } from "@/app/features/auth/utils";
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input placeholder="Ex: Inventto Tech" {...field} disabled={isPending} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
              ...
              <FormItem>
                ...
                <FormControl>
                  <div className="flex items-center">
                    <span className="text-sm text-muted-foreground mr-1">app.inventto.com/</span>
                    <Input {...field} disabled={isPending} />
                  </div>
                </FormControl>
                <FormDescription>Identificador único usado na URL.</FormDescription>
                <FormMessage />
              </FormItem>
            )}
          />
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input placeholder="00.000.000/0001-00" {...field} disabled={isPending} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
