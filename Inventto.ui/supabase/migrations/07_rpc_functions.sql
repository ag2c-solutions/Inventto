...
-- ------------------------------------------------------------------------------
-- GET_ATTENTION_SUMMARY (RF036/DASH-02): bloco 1 do Dashboard — contagens
-- acionáveis da org do usuário autenticado, recortadas por papel (RN091):
-- Sales só recebe "expiring_soon" (pool perto de expirar); Owner/Manager
-- recebem os três. Reusa a mesma janela de 30 min de
-- notify_expiring_orders/PED-03 (RN085/RN089) e a mesma regra de estoque
-- crítico/zerado de get_low_stock_count (RN050, 10_realtime.sql).
-- ------------------------------------------------------------------------------
