-- ==============================================================================
-- 13_RECENT_ACTIVITY.SQL
-- DASH-04 · Bloco 3 · Atividade recente e atalhos (RF038)
-- Dependência: 05_sales_schema.sql, 06_movements_schema.sql
-- ==============================================================================

-- getOrders (features/orders) e este bloco ordenam por updated_at DESC;
-- não havia índice cobrindo essa ordenação por organização.
CREATE INDEX IF NOT EXISTS idx_orders_org_updated
  ON public.orders (organization_id, updated_at DESC);

-- ==============================================================================
-- GET_RECENT_ACTIVITY (RF038 · RN090/RN091)
-- Últimas 5 movimentações + últimos 5 pedidos da org para Manager/Owner;
-- últimas 5 vendas de balcão do próprio vendedor para Sales.
-- ==============================================================================
...
BEGIN
  ...
  -- RN091: Sales só recebe as próprias vendas de balcão recentes — nada de
  -- movimentações/pedidos da org (isso fica para Manager/Owner abaixo).
